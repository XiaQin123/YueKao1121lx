...
import com.bwie.xiaqin.yuekao1121lx.MyAddSubView;
...
public class CarAdapter extends BaseExpandableListAdapter {
    ...
    public CarAdapter(List<CarInfo.DataBean> sellerData, Context context) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = View.inflate(context, R.layout.car_group_view_layout_shopcar, null);
    ...
    public View getChildView(final int groupPosition,final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = View.inflate(context, R.layout.car_child_view_layout_shopcar, null);
